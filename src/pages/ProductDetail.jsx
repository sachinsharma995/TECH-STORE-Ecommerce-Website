    ...
    <>
      <div className="mx-auto px-4 pt-0 min-xl">
        <div className="bg-gray-900 rounded-2xl shadow-2xl my-8 p-6 md:p-12 border border-gray-800 min-h-screen">
          <Link to={"/"}>
            <button
              className="flex items-center text-gray-400 hover:text-orange-400 transition duration-150 mb-7
        font-semibold text-lg cursor-pointer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-1">
            ...
            <div className="flex flex-col justify-between">
              ...
              <p className="text-3xl font-extrabold text-orange mb-4">
                ₹{product.price.toFixed(2)}
              </p>
              <h2
                className="text-xl font-bold text-gray-200 mb-2 border-b border-orange-900/50 pb-2 flex items-center
               space-x-2"
              >
              ...
              <ul className="space-y-3 text-gray-300 p-4 bg-gray-800 rounded-xl border border-gray-700 ">
                <li className="flex items-center space-x-3 text-lg">
                  ...
                  <span>High-Quality,Profession Grade Material</span>
                </li>
                <li className="flex items-center space-x-3 text-lg">
                  <Zap className="w-5 h-5 text-orange-500" />
              ...
              <Link
                to={"/"}
                className="mt-3 w-full py-3 border-2 border-orange-600  text-orange-400 font-bold rounded-full shadow-lg
           cursor-pointer hover:bg-orange-900/50 transition duration-300 text-center upperCase tracking-wider"
              >
                Keep Shopping
              </Link>
            </div>
